...
/** Default change observer. *//*
    ...
    public PinnedSectionExpandableListView(Context context, AttributeSet attrs, int defStyle) {
...
/** Create shadow wrapper with a pinned view for a view at given position *//*
    ...
    void createPinnedShadow(int position) {
        ...
        View pinnedView = getAdapter().getView(position, pinnedShadow.view, PinnedSectionExpandableListView.this);
